...
public class AttributeTest {
    ...
    public void testGetters() {
        Attribute a1 = new Attribute("resultType", "foo.Bar");
    ...
    public void testEquals() {
        Attribute a1 = new Attribute("resultType", "foo.Bar");
        Attribute a2 = new Attribute("resultType", "foo.Bar");
    ...
    public void testEqualsWithNull1() {
        Attribute a1 = new Attribute(null, "foo.Bar");
        Attribute a2 = new Attribute("resultType", "foo.Bar");
    ...
    public void testEqualsWithNull2() {
        Attribute a1 = new Attribute("resultType", null);
        Attribute a2 = new Attribute("resultType", "foo.Bar");
        assertThat(a1, not(equalTo(a2)));
    }
    ...
    public void testEqualsWithNull3() {
        Attribute a1 = new Attribute("resultType", "foo.Bar");
        Attribute a2 = new Attribute(null, "foo.Bar");
        assertThat(a1, not(equalTo(a2)));
    }
    ...
    public void testEqualsWithNull4() {
        Attribute a1 = new Attribute("resultType", "foo.Bar");
        Attribute a2 = new Attribute("resultType", null);
        assertThat(a1, not(equalTo(a2)));
    }
    ...
    public void testEqualsWithNull6() {
        Attribute a1 = new Attribute(null, null);
        Attribute a2 = new Attribute(null, null);
        assertThat(a1, equalTo(a2));
    }
    ...
    public void testCompareToLessThan1() {
        Attribute a1 = new Attribute("a", "c");
        Attribute a2 = new Attribute("b", "c");
    ...
    public void testCompareToLessThan2() {
        Attribute a1 = new Attribute("a", "c");
        Attribute a2 = new Attribute("a", "d");
        assertThat(a1.compareTo(a2) < 0, is(true));
    }
}
